...
DATABASES = {
    'default': {
        ...
        'NAME': local_settings.PATH+'database.db',                      # Or path to database file if using sqlite3.
...
LANGUAGE_CODE = local_settings.LANGUAGE
...
MEDIA_ROOT = local_settings.PATH+'media/'
...
STATIC_ROOT = local_settings.PATH+'static/'
